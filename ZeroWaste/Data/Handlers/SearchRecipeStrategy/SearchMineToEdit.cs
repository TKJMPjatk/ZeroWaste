...
public class SearchMineToEdit : ISearchRecipeStrategy
{
    ...
    public SearchMineToEdit(IRecipesSearchService recipesSearchService, IMapper mapper)
    {
    ...
    {        
        var list = await _recipesSearchService.GetEditMineByUserAsync(searchRecipeResultsVm.UserId);
